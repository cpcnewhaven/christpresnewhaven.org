                            ...
                            <tr>
                              ...
                              <div align="left">
                                <table border="0" cellpadding="0" cellspacing="0" width="400">
                                  ...
                                  <tr>
                                    <td width="46">&nbsp;</td>
                                    <td><font face="Arial" size="2" style="font-size: 11px; line-height: 14px">Add, edit, or remove folders from the system. Please note, you cannot remove a folder containing any postings. Please remove all postings from this folder first.<br><br></font>
                                    <% if Session("DeleteError") = True then %><font face="Arial" size="2" style="font-size: 11px; line-height: 14px" color="#FF0000">There are postings still within this folder. Please remove these posts before removing the folder.<br><br></font><% Session("DeleteError") = False %><% end if %>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td width="46">&nbsp;</td>
                                    <td><table border="0" cellpadding="1" cellspacing="0" width="100%">
                                      <tr height="22" bgcolor="#DBDBDB">
                                        <td><font face="Arial" size="2" style="font-size: 11px; line-height: 14px">Folder Name</font></td>
                                      ...
                                      <tr height="22" bgcolor="#FFFFFF" onMouseOver="style.cursor='hand'; if (deleteAction == true) { this.style.background='#FF0000' } else { this.style.background='#F3F3F3' }" onMouseOut="this.style.background='#FFFFFF'">
                                        <td onClick="window.location='dmac.folders.details.asp?FolderID=<% =rstFolders("FolderID") %>'" onMouseOver="deleteAction=false"><font face="Arial" size="2" style="font-size: 11px; line-height: 14px"><% =rstFolders("FolderName") %></font></td>
                                        <td onClick="if (confirm('Are you sure you want to delete this folder?')) { window.location='dmac.folders.details.save.asp?Action=Delete&FolderID=<% =rstFolders("FolderID") %>' }" onMouseOver="deleteAction=true" align="center"><font face="Arial" size="2" style="font-size: 10px; line-height: 14px">X</font></td>
                                      </tr>
                                  ...
                                  <tr>
                                    <td width="46">&nbsp;</td>
                                    <td align="center"><input type="button" onClick="window.location='dmac.folders.details.asp?Add=1'" style="font-family: Arial; font-size: 11px; height: 25px; width: 90px" value="Add"></td>
                                  </tr>
                                </table>
                              </div>
                              </td>
