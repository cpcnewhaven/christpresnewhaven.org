...
<title>DMAC - Users</title></head>

<body bgcolor="#DBDBDB" onLoad="document.all.txtFirstName.focus(); document.all.txtFirstName.select()">
                              ...
                              <div align="left">
                                <table border="0" cellpadding="0" cellspacing="0" width="450">
                                  ...
                                  <tr>
                                    <td width="46">&nbsp;</td>
                                    <td>
                                    <form method="post" action="dmac.users.details.save.asp">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="385">
                                      ...
                                      <tr>
                                      	<td width="90"><font face="Arial" size="2" style="font-size: 11px; line-height: 14px"><b>First Name:</b></font></td>
                                      	<td width="295"><font face="Arial" size="2" style="font-size: 11px; line-height: 14px"><input type="text" name="txtFirstName" <% if UserID <> "" then %>value="<% =rstUser("FirstName") %>" tabindex="1" onFocus="this.style.background='#F3F3F3'" onBlur="this.style.background='#FFFFFF'" style="border: 1px solid #000000; font-family: Arial; font-size: 11px; width: 100%" size="20" <% end if %>></td>
                                      </tr>
                                      <tr>
                                        <td height="4"></td>
                                      </tr>
                                      <tr>
                                      	<td width="90"><font face="Arial" size="2" style="font-size: 11px; line-height: 14px"><b>Last Name:</b></font></td>
                                      	<td width="295"><font face="Arial" size="2" style="font-size: 11px; line-height: 14px"><input type="text" name="txtLastName" <% if UserID <> "" then %>value="<% =rstUser("LastName") %>" tabindex="2" onFocus="this.style.background='#F3F3F3'" onBlur="this.style.background='#FFFFFF'" style="border: 1px solid #000000; font-family: Arial; font-size: 11px; width: 100%" size="20" <% end if %>></td>
                                      </tr>
                                      <tr>
                                        <td height="4"></td>
                                      </tr>
                                      <tr>
                                      	<td width="90"><font face="Arial" size="2" style="font-size: 11px; line-height: 14px"><b>Email Address:</b></font></td>
                                      	<td width="295"><font face="Arial" size="2" style="font-size: 11px; line-height: 14px"><input type="text" name="txtEmailAddress" <% if UserID <> "" then %>value="<% =rstUser("EmailAddress") %>" tabindex="3" onFocus="this.style.background='#F3F3F3'" onBlur="this.style.background='#FFFFFF'" style="border: 1px solid #000000; font-family: Arial; font-size: 11px; width: 100%" size="20" <% end if %>></td>
                                      </tr>
                                      <tr>
                                        <td height="4"></td>
                                      </tr>
                                      <tr>
                                      	<td width="90"><font face="Arial" size="2" style="font-size: 11px; line-height: 14px"><b>Username:</b></font></td>
                                      	<td width="295"><font face="Arial" size="2" style="font-size: 11px; line-height: 14px"><input type="text" name="txtUsername" <% if UserID <> "" then %>value="<% =rstUser("Username") %>" tabindex="4" onFocus="this.style.background='#F3F3F3'" onBlur="this.style.background='#FFFFFF'" style="border: 1px solid #000000; font-family: Arial; font-size: 11px; width: 100%" size="20" <% end if %>></td>
                                      </tr>
                                      <tr>
                                        <td height="4"></td>
                                      </tr>
                                      <tr>
                                      	<td width="90"><font face="Arial" size="2" style="font-size: 11px; line-height: 14px"><b>Password:</b></font></td>
                                      	<td width="295"><font face="Arial" size="2" style="font-size: 11px; line-height: 14px"><input type="password" name="txtPassword" <% if UserID <> "" then %>value="<% =rstUser("Password") %>" tabindex="5" onFocus="this.style.background='#F3F3F3'" onBlur="this.style.background='#FFFFFF'" style="border: 1px solid #000000; font-family: Arial; font-size: 11px; width: 100%" size="20" <% end if %>></td>
                                      </tr>
                                      <tr>
                                        <td height="4"></td>
                                      </tr>
                                      <tr>
                                      	<td width="90"><font face="Arial" size="2" style="font-size: 11px; line-height: 14px"><b>Admin:</b></font></td>
                                      	<td width="295"><font face="Arial" size="2" style="font-size: 11px; line-height: 14px"><input type="checkbox" name="chkAdmin" value="ON" <% if UserID <> "" then %><% if rstUser("Admin") then %>checked<% end if %><% end if %>></td>
                                      </tr>
                                      <tr>
                                        <td height="4"></td>
                                      </tr>
                                      <tr>
                                      	<td width="90"><font face="Arial" size="2" style="font-size: 11px; line-height: 14px"><b>Locked Out:</b></font></td>
                                      	<td width="295"><font face="Arial" size="2" style="font-size: 11px; line-height: 14px"><input type="checkbox" name="chkLockedOut" value="ON" <% if UserID <> "" then %><% if rstUser("LockedOut") then %>checked<% end if %><% end if %>></td>
                                      </tr>
                                      <tr>
                                        <td height="14"></td>
                                      </tr>
                                      <tr>
                                        <td colspan="2" align="center"><input type="submit" style="font-family: Arial; font-size: 11px; height: 25px; width: 90px" value="Save">&nbsp;<input type="button" onClick="window.location='dmac.users.asp'" style="font-family: Arial; font-size: 11px; height: 25px; width: 90px" value="Cancel"></td>
                                      </tr>
                                    </table>
                                    </form>
                                    </td>
