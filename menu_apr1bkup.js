...
subMenuIds[0][1] = "CLASSES";		subMenuText[0][1] = "Classes";				subMenuUrls[0][1] = "sts/currentclassesindex.html";
subMenuIds[0][2] = "LEADERSHIP";	subMenuText[0][2] = "Leadership Training";		subMenuUrls[0][2] = "sts/leadershiptrainingindex.html";
subMenuIds[0][3] = "FAITHPRACT";	subMenuText[0][3] = "Christian Faith and Practice";	subMenuUrls[0][3] = "sts/cfpindex.html";
subMenuIds[0][4] = "PAPERS";		subMenuText[0][4] = "Papers";				subMenuUrls[0][4] = "sts/paperindex.html";
subMenuIds[0][5] = "PAMPHLETS";		subMenuText[0][5] = "Pamphlets";			subMenuUrls[0][5] = "sts/pamphletindex.html";
subMenuIds[0][6] = "CATALOGUE";		subMenuText[0][6] = "Library Catalogue";		subMenuUrls[0][6] = "sts/librarycatalogueindex.html";
subMenuIds[0][7] = "LINKS";		subMenuText[0][7] = "Links";				subMenuUrls[0][7] = "sts/linkindex.html";
subMenuIds[0][8] = "REDEMPTION";	subMenuText[0][8] = "Stories of Redemption";		subMenuUrls[0][8] = "sts/stoindex.html";
...
subMenuIds[3][3] = "REGSTRATEGY";	subMenuText[3][3] = "Regional Strategy";		subMenuUrls[3][3] = "abt/regional.html";
subMenuIds[3][4] = "HISTORY";		subMenuText[3][4] = "History of CPC";			subMenuUrls[3][4] = "abt/cpchistory.html";
subMenuIds[3][5] = "CHILDREN";		subMenuText[3][5] = "Children and Youth at CPC";	subMenuUrls[3][5] = "abt/ministrydirectoryindex.html";
subMenuIds[3][6] = "INNEWS";		subMenuText[3][6] = "In the News";			subMenuUrls[3][6] = "http://www.pcanet.org/mna/multiply/multiply2002/spring2002/spring2002.htm#NewHaven";
...
// The Window
subMenuIds[5][0] = "SPRING03";		subMenuText[5][0] = "Spring 2003";			subMenuUrls[5][0] = "win/thewindow_5-1_web.pdf";
subMenuIds[5][1] = "SUMMER02";		subMenuText[5][1] = "Summer 2002";			subMenuUrls[5][0] = "win/thewindow_4-1_web.pdf";
subMenuIds[5][2] = "FALL01";		subMenuText[5][2] = "Fall 2001";			subMenuUrls[5][0] = "win/thewindow_3-3_web.pdf";
subMenuIds[5][3] = "SUMMER01";		subMenuText[5][3] = "Summer 2001";			subMenuUrls[5][0] = "win/thewindow_3-2_web.pdf";
subMenuIds[5][4] = "FALL00";		subMenuText[5][4] = "Fall 2000";			subMenuUrls[5][0] = "win/thewindow_2-3_web.pdf";
subMenuIds[5][5] = "SUMMER00";		subMenuText[5][5] = "Summer 2000";			subMenuUrls[5][0] = "win/thewindow_2-2_web.pdf";
subMenuIds[5][6] = "WINTER00";		subMenuText[5][6] = "Winter 2000";			subMenuUrls[5][0] = "win/thewindow_2-1_web.pdf";
subMenuIds[5][7] = "FALL99";		subMenuText[5][7] = "Fall 1999";			subMenuUrls[5][0] = "win/thewindow_1-3_web.pdf";
subMenuIds[5][8] = "SUMMER99";		subMenuText[5][8] = "Summer 1999";			subMenuUrls[5][0] = "win/thewindow_1-2_web.pdf";
...
// Media
subMenuIds[7][0] = "INTOTHYLT";		subMenuText[7][0] = "Into Thy Light";			subMenuUrls[7][0] = "cd/";
subMenuIds[7][1] = "DOWNLOAD";		subMenuText[7][1] = "Downloadable Sermons (MP3)";	subMenuUrls[7][1] = "sts/sermons/downloadsindex.html";
